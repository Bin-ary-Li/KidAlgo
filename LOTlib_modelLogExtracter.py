...
sortOut = './ModelLog_SortMultiHyp.txt'
doubleOut = './ModelLog_DoubleMultiHyp.txt'
hitchOut = './ModelLog_HitchMultiHyp.txt'
sortAlgoType = "Sort"
...
df.to_csv(path_or_buf='./multiHypData.csv', index=False)
